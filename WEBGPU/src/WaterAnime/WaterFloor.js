...
export class WaterFloor {
    constructor(scene) {
        this.material = new THREE.ShaderMaterial({
            ...
            uniforms: {
                ...
                uEdgeThreshold: { value: 0.025 },
                uEdgeSoftness: { value: 0.015 },
                uFlowX: { value: 0.02 },
                uFlowZ: { value: -0.04 },
                uCellSpeed: { value: 0.45 },
                uNoiseScale: { value: 0.003 },
                uNoiseFlowSpeed: { value: 0.08 },
                uDistortAmount: { value: 0.15 },
                uDeepColor: { value: new THREE.Color("#1a4a8c") },
                uMidColor: { value: new THREE.Color("#4da9e8") },
                uMidPos: { value: 0.35 },
                uHighlight: { value: new THREE.Color("#ffffff") },
                uOpacity: { value: 0.95 },
                uDeepOpacity: { value: 0.85 },
    ...
    update(dt, elapsedTime, camera, rippleStore) {
        ...
        if (rippleStore) {
            ...
            const ripples = rippleStore.ripples;
