uniform vec3 iResolution;
      ...
      vec3 skyColor(vec3 ro, vec3 rd) {
        ...
        vec3 smallSunCol = 0.5*smallSunCol1*pow(smallSunDot, 20.0) + 8.0*smallSunCol2*pow(smallSunDot, 20000.0);
      ...
      vec3 getSampleInteractive(vec2 p) {
        vec3 ro = iCamPos;
        vec3 la = iCamTarget;
      ...
      void main() {
        ...
        vec3 col = getSampleInteractive(p);
